...
// HTTP behaviour is covered in espn_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "espn://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("espn", "about")
	if err != nil || got.String() != "espn://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want espn://page/about", got.String(), err)
	}
}
