---
title: "espn"
description: "A command line for ESPN sports data."
heroTitle: "espn, from the command line"
heroLead: "A command line for ESPN sports data. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
espn links <path>           # the pages it links to, each addressable
espn serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading espn by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address espn as
  `espn://` URIs and follow links across sites. See
